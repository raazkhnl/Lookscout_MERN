...
const Header = () => {
    ...
    return (
        <header className="navbar navbar-expand-lg bg-color-gray p-2" >
            <div className="container-fluid mx-4">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav px-2 me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link active nav-text" aria-disabled="true" >Contacts</Link>
                        </li>
                    </ul>
                    <button className="btn text-primary" type="submit" >Sign Up</button>
